      ...
      <div className="relative w-full max-w-md bg-white rounded-2xl shadow-2xl overflow-hidden transform transition-all duration-300 scale-100 animate-in zoom-in-95">
        ...
        <form onSubmit={handleSubmit} className="p-8 space-y-6 bg-white">
          ...
          <button
            ...
            className="w-full flex items-center justify-center gap-3 bg-white border-2 border-gray-200 hover:border-blue-600 hover:bg-blue-50 text-gray-700 py-3 px-4 rounded-lg transition-all duration-200 font-medium shadow-sm hover:shadow-md"
          >
