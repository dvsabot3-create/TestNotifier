  ...
  const features = [
    {
      ...
      description: "Our system continuously checks DVSA availability across all test centres, every minute of every day. Faster than manual checking, smarter than basic bots.",
    ...
    },
    {
      ...
      description: "Get alerted within 30 seconds when slots appear. SMS, email, or push notification - your choice. Instructors can set up notifications for each pupil.",
      benefits: ["30-second alerts", "SMS + Email + Push", "Per-pupil settings"],
      gradient: "from-green-500 to-emerald-500"
    },
    {
      icon: MapPin,
      title: "Multiple Pupils & Centers",
      description: "Monitor up to 10+ centers per pupil. Instructors can manage up to 20 pupils on Pro plans - all from one dashboard.",
      benefits: ["10+ centres", "Multi-pupil mgmt", "One dashboard"],
      gradient: "from-purple-500 to-pink-500"
    },
    {
      icon: Settings,
      title: "Smart Filtering",
      description: "Set preferred dates, times, and centers for each pupil. Only get notified for slots that actually work for your schedule.",
      benefits: ["Custom per pupil", "Time preferences", "Date ranges"],
      gradient: "from-orange-500 to-red-500"
    },
    {
      icon: Rocket,
      title: "5-Minute Setup",
      description: "Install the Chrome extension, add your pupils (or just yourself), set preferences, and go. It's that simple.",
      benefits: ["Quick install", "Easy config", "Instant activation"],
      gradient: "from-indigo-500 to-blue-500"
    },
    {
      icon: Shield,
      title: "Stealth & Compliant",
      description: "Advanced anti-detection keeps you under the radar. Fully compliant - we never access credentials or force-book anything.",
      benefits: ["Undetectable", "100% legal", "You control bookings"],
      ...
      <div className="max-w-7xl mx-auto relative z-10">
        ...
        <div className="text-center mb-16">
          ...
          <p className="solution-description text-xl text-gray-600 max-w-3xl mx-auto leading-relaxed">
            Stop wasting time with manual checks. TestNotifier monitors test availability 24/7 and notifies you instantly when slots appear. Built for both individual learners and driving schools managing multiple pupils.
          </p>
        </div>
