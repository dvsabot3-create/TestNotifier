      ...
      <div className="max-w-7xl mx-auto px-6 py-24 relative z-10">
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          ...
          <div className="hero-visual relative z-10">
            ...
            {/* Floating Notification Cards - Glass effect with overlap */}
            <div className="floating-notification-1 absolute -top-6 -right-6 bg-white/95 backdrop-blur-md rounded-2xl p-4 shadow-2xl max-w-xs hidden lg:block border border-gray-100">
              <div className="flex items-start gap-3">
            ...
            <div className="floating-notification-2 absolute -bottom-6 -left-6 bg-white/95 backdrop-blur-md rounded-2xl p-4 shadow-2xl max-w-xs hidden lg:block border border-gray-100">
              <div className="flex items-start gap-3">
