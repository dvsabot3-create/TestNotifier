...
export function DemoSection() {
  const handleScreenshotDemo = () => {
    // Open first installation screenshot in a new tab
          ...
          <div className="bg-white rounded-3xl p-8 shadow-2xl border border-gray-200">
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
              {[
                ...
                const screenshotData = ScreenshotHelper.getScreenshotData(step.id);
                const imagePath = ScreenshotHelper.getImagePath(step.id);
                ...
                return (
                  <div key={step.id} className="group cursor-pointer" onClick={handleStepClick}>
                      ...
                      <div className="flex items-center gap-2">
                        {imagePath ? (
                          <>
                            ...
                            <span className="text-xs text-green-600 font-medium">Screenshot Available</span>
                          </>
                        ) : (
                          <>
