          ...
          <div className="flex flex-col sm:flex-row flex-wrap justify-center items-center gap-6 sm:gap-8">
            <div className="flex items-center justify-center gap-3 w-full sm:w-auto">
              ...
              <div className="text-center sm:text-left">
                <p className="text-lg text-[#1d70b8] font-semibold">Chrome Web Store</p>
                <p className="text-sm text-[#6c757d]">Verified Extension</p>
              </div>
            </div>
            <div className="flex items-center justify-center gap-3 w-full sm:w-auto">
              <div className="w-12 h-12 bg-[#1d70b8] rounded-full flex items-center justify-center flex-shrink-0">
                <Star className="w-6 h-6 text-white fill-current" />
              </div>
              <div className="text-center sm:text-left">
                <p className="text-lg text-[#1d70b8] font-semibold">4.8/5 Rating</p>
            ...
            <div className="flex items-center justify-center gap-3 w-full sm:w-auto">
              ...
              <div className="text-center sm:text-left">
                <p className="text-lg text-[#1d70b8] font-semibold">500+ Users</p>
