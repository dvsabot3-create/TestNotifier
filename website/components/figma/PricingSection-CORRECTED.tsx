  ...
  const plans = [
    ...
    },
    {
      ...
      features: [
        ...
        { text: "Up to 3 pupils", included: true },
    ...
    },
    {
      ...
      features: [
        ...
        { text: "Up to 10 pupils", included: true },
      ...
      <div className="max-w-7xl mx-auto">
        <div className="text-center mb-16">
          ...
          <p className="pricing-description text-xl text-[#6c757d] max-w-3xl mx-auto mb-8">
            Simple pricing for learners and instructors. One-off rescue bookings or ongoing monitoring for driving schools.
          </p>
        ...
        <div className="mt-16 bg-gradient-to-r from-blue-50 to-purple-50 rounded-2xl p-8 max-w-5xl mx-auto border border-blue-100">
          ...
          <div className="grid md:grid-cols-2 gap-6 text-left">
                <div className="bg-white rounded-xl p-6 border border-blue-200">
                  ...
                  <div className="text-xs text-[#6c757d] space-y-1">
                    <p>• 1 daily booking attempt</p>
                    <p>• 5 daily notifications max</p>
                    <p>• 1 test center monitoring</p>
                  </div>
                  <p className="text-xs text-[#856404] bg-yellow-50 p-2 rounded mt-3">
            ...
            <div className="bg-white rounded-xl p-6 border border-blue-200">
              ...
              <p className="text-sm text-[#6c757d] mb-3">
                ...
                During your 3-day preview, you can see all available slots but can't rebook yet. After payment, your daily booking attempts activate.
              </p>
              <div className="text-xs text-[#6c757d] space-y-1">
                <p>• Daily booking attempts (not monthly)</p>
                <p>• Daily notification limits apply</p>
                <p>• Pupil and test center limits enforced</p>
              </div>
              <p className="text-xs text-[#856404] bg-yellow-50 p-2 rounded mt-3">
                <strong>Anti-Abuse:</strong> Prevents system abuse - you must pay to rebook
              </p>
            </div>

            <div className="bg-white rounded-xl p-6 border border-blue-200">
              <h5 className="font-bold text-[#1d70b8] mb-3">Daily Limits by Plan</h5>
              <ul className="text-sm text-[#6c757d] space-y-2">
                <li><strong>One-Off:</strong> 1 booking attempt, 5 notifications</li>
                <li><strong>Starter:</strong> 2 booking attempts, 10 notifications</li>
                <li><strong>Premium:</strong> 5 booking attempts, 25 notifications</li>
                <li><strong>Professional:</strong> 10 booking attempts, 50 notifications</li>
              </ul>
              <p className="text-xs text-[#28a745] bg-green-50 p-2 rounded mt-3">
                <strong>Resets daily at midnight UTC</strong>
              </p>
            </div>

            <div className="bg-white rounded-xl p-6 border border-blue-200">
              <h5 className="font-bold text-[#1d70b8] mb-3">Plan Comparison</h5>
              <ul className="text-sm text-[#6c757d] space-y-2">
                <li><strong>Need 1 rebook?</strong> £25 one-off</li>
                <li><strong>Need 2 attempts/day?</strong> Starter (£19/month)</li>
                <li><strong>Need 5 attempts/day?</strong> Premium (£29/month)</li>
                <li><strong>Instructor with multiple pupils?</strong> Pro (£89/month)</li>
              </ul>
              <p className="text-xs text-[#6c757d] bg-gray-50 p-2 rounded mt-3">
                <strong>Note:</strong> All limits are daily, not monthly. Professional has highest limits.
              </p>
            </div>
          </div>
          ...
          <div className="mt-6 bg-yellow-50 border border-yellow-200 rounded-lg p-4">
            <h6 className="font-bold text-[#856404] mb-2">⚠️ Important Usage Information</h6>
            <ul className="text-xs text-[#856404] space-y-1">
              <li>• All subscription plans have daily limits that reset at midnight UTC</li>
              <li>• "Booking attempts" refer to daily automated booking tries, not monthly quotas</li>
              <li>• Professional plan supports up to 20 pupils (not unlimited) and 999 test centers</li>
              <li>• Notification limits include all channels (SMS, Email, WhatsApp)</li>
              <li>• Extra rebook purchases are not available - daily limits are strictly enforced</li>
            </ul>
          </div>
        </div>
      </div>
