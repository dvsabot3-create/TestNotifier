...
export function ProblemSection() {
  const problems = [
    ...
    },
    {
      ...
      description: "Cancellations vanish in under a minute. By the time you check, it's already gone - beaten by bots."
    },
    {
      icon: AlertCircle,
      stat: "5-10",
      label: "Pupils per instructor",
      title: "Instructor Nightmare",
      description: "Managing test bookings for multiple pupils manually? Impossible to monitor 5+ centres for each student 24/7."
    },
    {
      icon: Frown,
      stat: "3-6mo",
