...
export function FAQSection() {
  const faqs = [
    ...
    },
    {
      ...
      answer: "You can monitor any DVSA test centre in England, Scotland, and Wales. Our Free plan allows 1 centre, Pro plan allows up to 5 centres, and Instructor plan allows unlimited centres. You can change which centres you're monitoring at any time."
    },
    {
