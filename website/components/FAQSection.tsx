...
export function FAQSection() {
  const faqs = [
    ...
    },
    {
      ...
      answer: "You can monitor any DVSA test centre in England, Scotland, and Wales. Our One-Off plan allows 1 centre, Starter plan allows up to 3 centres, Premium plan allows up to 5 centres, and Professional plan allows up to 999 centres. You can change which centres you're monitoring at any time."
    },
    {
